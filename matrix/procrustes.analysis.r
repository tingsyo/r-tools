#=======================================================================
# R functions for Procrustes Analysis
#=======================================================================
# Apache License v.2
# T.S.Yo 2008.11.07
#=======================================================================
#=======================================================================
#  Ref:
#   wikipedia: http://en.wikipedia.org/wiki/Procrustes_analysis
#=======================================================================

#=======================================================================
proscrustes.analysis <- function(m1, m2, nrep=1000, stat="z", rseed=NULL){
#=======================================================================
# Description:
...
#         }}
  ...
  #=======================================================================
    ...
    cat(paste("P-value:",p,"\n"))
    invisible(list(mantel.obs=mantel.obs,mantel.sample=mantel.sample,p=p))
}